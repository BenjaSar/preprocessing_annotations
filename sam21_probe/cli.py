...
Usage (from preprocessing_annotations/):
...
SAM2_CHECKPOINT = str(Path(__file__).resolve().parent.parent.parent / "sam2_checkpoints" / "sam2.1_hiera_large.pt")
...
def main() -> None:
    ...
    out_path = Path(__file__).resolve().parent.parent.parent / "sam21_probe_out" / "report.json"
