...
def test_b4_temperature_control():
    ...
    try:
        ...
        backend_file = Path(__file__).parent / "vlm_backend.py"
...
def test_b3_polygon_fallback():
    ...
    try:
        reconciler_file = Path(__file__).parent / "semantic_reconciler.py"
...
def test_b1_cudnn_fallback():
    ...
    try:
        ocr_file = Path(__file__).parent / "ocr_adapter.py"
